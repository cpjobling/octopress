...
site_url    = "http://dev.cpjobling.org.uk"   # deployed site url for sitemap.xml generator
...
## -- Rsync Deploy config -- ##
ssh_user      = "cpjoblin@cpjobling.me"    # for rsync deployment
document_root = "~/public_html/dev/" # for rsync deployment
## ---- ##
